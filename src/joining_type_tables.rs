...
pub const JOINING_TYPE: &'static [(u32, u32, JoiningType)] = &[
    ...
    (3791, 3863, JoiningType::NonJoining),
    ...
    (70207, 70208, JoiningType::NonJoining),
    (70209, 70209, JoiningType::Transparent),
    (70210, 70366, JoiningType::NonJoining),
    ...
    (73461, 73471, JoiningType::NonJoining),
    (73472, 73473, JoiningType::Transparent),
    (73474, 73525, JoiningType::NonJoining),
    (73526, 73530, JoiningType::Transparent),
    (73531, 73535, JoiningType::NonJoining),
    ...
    (122923, 123022, JoiningType::NonJoining),
    (123023, 123023, JoiningType::Transparent),
    (123024, 123183, JoiningType::NonJoining),
